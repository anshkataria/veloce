    ...
    <main className="auth-page">
      ...
      <section className="auth-visual">
        <img
          src={image}
          alt=""
          className="auth-visual__image opacity-82"
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`auth-input w-full rounded-[8px] border bg-[color-mix(in_srgb,var(--surface)_80%,transparent)] px-4 text-sm text-[var(--ink)] outline-none transition-colors duration-[260ms] ease-[var(--ease-premium)] hover:border-[var(--ink-muted)] focus:border-[var(--oxblood)] focus:ring-2 focus:ring-[color-mix(in_srgb,var(--oxblood)_16%,transparent)] ${
